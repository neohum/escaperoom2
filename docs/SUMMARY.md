...
교육용 방탕출 컨텐츠을 제작하고 배포할 수 있는 웹 기반 플랫폼

### 핵심 사용자

1. **전체 관리자**: 시스템 전체 관리, 사용 현황 모니터링
2. **컨텐츠 제작자**: 컨텐츠 제작 및 편집 (로그인/비로그인 가능)
3. **사용자**: 컨텐츠 플레이 (비로그인 가능, 로그인 시 뱃지/기록 저장)
...
1. **비로그인 편집**: 가입 없이도 컨텐츠 제작 가능 (편집 토큰)
